...
class ShowMatcheDay extends StatefulWidget {
  ...
  @override
  State<ShowMatcheDay> createState() => _ShowMatcheDayState();
}

class _ShowMatcheDayState extends State<ShowMatcheDay> {
                    ...
                    child: TextButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push( context, //abre uma tela sobre outra (o context é o contexto da tela atual, o método build já trás pra gente automaticamente)
                          MaterialPageRoute(
                            builder: (context) => ShowTableMatches(idCompetition: widget.idCompetition, regiao: widget.regiao, ano: widget.ano, usuario: widget.usuario,),
